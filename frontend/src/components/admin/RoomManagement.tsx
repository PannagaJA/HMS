    ...
    <div className="space-y-6">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {/* Quick Delete for Vacant Rooms */}
                    {room.occupied_count === 0 && (
                      <button
                        onClick={(e) => handleDeleteRoom(e, room.id, room.no)}
                        className="p-1 rounded-lg bg-white/80 hover:bg-rose-50 text-slate-400 hover:text-rose-600 transition-colors border border-slate-200 shadow-2xs cursor-pointer opacity-80 hover:opacity-100"
          ...
          <div className="bg-white w-full max-w-lg rounded-3xl border border-slate-200/80 shadow-2xl p-6 sm:p-7 relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-6 mt-6 border-t border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                {selectedRoom.occupied_count === 0 && (
                  <button
                    type="button"
                    onClick={(e) => {
                      setShowOccupantsDrawer(false);
                      handleDeleteRoom(e, selectedRoom.id, selectedRoom.no);
                    }}
                    className="px-4 py-2 rounded-full border border-rose-200 bg-rose-50/50 text-xs font-semibold text-rose-600 hover:bg-rose-100 flex items-center gap-1.5 cursor-pointer shadow-2xs transition-colors"
                  >
      ...
      {showEditRoomModal && editingRoom && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-150">
          <div className="bg-white w-full max-w-md rounded-3xl p-6 sm:p-7 border border-slate-200 shadow-2xl relative z-50">
