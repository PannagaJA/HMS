  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-3xl border border-slate-200/80 shadow-xs space-y-3">
        {/* Row 1: Search Input + Active Residents Badge */}
        <div className="flex items-center gap-3">
          ...
          <div className="text-xs font-semibold px-3.5 py-2 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-200 whitespace-nowrap shrink-0">
            {filteredResidents.length} Active Residents
          </div>
        </div>

        {/* Row 2: Hostel Selector & Floor Selector */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-2 border-t border-slate-100">
          {hostels.length > 1 ? (
            <div className="flex items-center gap-2.5 w-full sm:w-auto">
              <span className="text-xs font-semibold text-slate-500 whitespace-nowrap shrink-0 flex items-center gap-1">
              ...
              <div className="flex-1 min-w-0 sm:w-60">
                ...
                >
                  <SelectTrigger className="h-9 rounded-full bg-slate-50 text-xs font-semibold shadow-xs border border-slate-200 px-3.5">
          ...
          <div className="flex items-center gap-2.5 w-full sm:w-auto">
            ...
            <div className="flex-1 min-w-0 sm:w-[180px]">
              <Select value={floorFilter} onValueChange={setFloorFilter}>
                <SelectTrigger className="h-9 w-full bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-800 rounded-full px-3.5">
