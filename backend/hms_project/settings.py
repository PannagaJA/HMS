...
# Ensure backend root is on sys.path for wsgi/asgi/runserver imports
if str(BASE_DIR) not in sys.path:
    sys.path.insert(0, str(BASE_DIR))

load_dotenv(BASE_DIR / '.env')

SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-hms-modular-secret-key-2026')
